...
result_dir = './drive/My Drive/Colab Notebooks/6. Unet/pytorch_unet_36/results'
...
dataset_test = CustomDataset(data_dir=os.path.join(data_dir,'test'), transform=transform)
...
with torch.no_grad():
    ...
    for batch, data in enumerate(loader_test, 1):
        ...
        print("Train: BATCH %04d / %04d | LOSS(mean per epoch) %.4f" %
        ...
        # test 결과를 results 폴더에 numpy, png 파일로 각각 저장
